...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        if (auth()->user()->hasRole('Admin')){
            ...
            $invoices = InvoiceDetail::with('product', 'user')->whereMonth('created_at', '=', date('m'))->whereDay('created_at', '=', date('d'))->orderBy('id', 'desc')->paginate(10);
        ...
        $invoices = InvoiceDetail::with('product', 'user')->whereMonth('created_at', '=', date('m'))->whereDay('created_at', '=', date('d'))->where('user_id', auth()->user()->id)->orderBy('created_at', 'desc')->paginate(10);
