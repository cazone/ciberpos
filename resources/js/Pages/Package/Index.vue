  ...
  <app-layout title="Lista">
    ...
    <div class="page-header">
						<div class="page-title">
							<h4>Lista de paquetes de productos</h4>
							<h6>Ver/Buscar paquetes de producto</h6>
						</div>
						<div class="page-btn">
							<Link :href="route('package.create')"  class="btn btn-added">
								<img src="assets/img/icons/plus.svg"  class="me-1" alt="img">Nueva Paquete
							</Link>
						</div>
					</div>
          <!-- <div class="card">
